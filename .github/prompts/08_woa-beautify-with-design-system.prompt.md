---
name: woa-beautify-with-design-system
description: Beautify the entire SwiftUI codebase using a consistent Apple-native design system while preserving all business logic, navigation, APIs, models, and CRUD workflows.
---
